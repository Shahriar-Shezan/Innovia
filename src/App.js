...
function App() {
  const routesArray = [
    ...
    { path: "/BuildPC", element: <BuildPC /> },
    { path: "/register", element: <Register /> },
    { path: "/home", element: <Home /> },
    { path: "/writeprocessor", element: <WriteProcessor /> },
    { path: "/devhome", element: <Devhome /> },
    { path: "/writemotherboard", element: <WriteMotherboard /> },
    { path: "/writegpu", element: <WriteGpu /> },
    { path: "/writeram", element: <WriteRam /> },
    { path: "/writestorage", element: <WriteStorage /> },
    { path: "/writepsu", element: <WritePsu /> },
    { path: "/writecasing", element: <WriteCasing /> },
